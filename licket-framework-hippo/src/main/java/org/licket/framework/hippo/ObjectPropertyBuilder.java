...
public class ObjectPropertyBuilder extends AbstractAstNodeBuilder<ObjectProperty> {
  ...
  public ObjectPropertyBuilder value(FunctionNodeBuilder functionNode) {
  ...
  public ObjectPropertyBuilder value(AbstractAstNodeBuilder<InfixExpression> expressionBuilder) {
